...
/**
 * Represents a review and rating submitted by a customer for a completed shoot booking.
 */
@Entity
...
public class Review {
    ...
    public Review(Booking booking, User customer, PhotographerProfile photographerProfile, Integer rating, String comment) {
