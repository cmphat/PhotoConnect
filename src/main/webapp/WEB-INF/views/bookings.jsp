...
<body>
    ...
    <main style="padding: 4rem 3rem;">
        <div style="max-width: 1000px; margin: 0 auto;">
            <h1 class="editorial-title" style="font-size: 3rem; margin-bottom: 2rem;">My Bookings</h1>
            ...
            <c:if test="${empty bookings}">
                <div class="pc-empty-state">
                    <h3 class="pc-empty-title">No bookings yet</h3>
                    <p class="pc-empty-desc">You haven't requested any photography sessions.</p>
                    <a href="/photographers" class="pc-btn-primary">Explore Photographers</a>
                </div>
            </c:if>
                ...
                <div style="display: grid; gap: 1.5rem;">
                    <c:forEach var="booking" items="${bookings}">
                        <div class="pc-content-section" style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                <h3 style="margin-bottom: 0.5rem; font-size: 1.25rem;">Session with ${booking.photographerName}</h3>
                            ...
                            <div style="text-align: right;">
                                ...
                                <a href="/bookings/${booking.id}" class="pc-btn-outline" style="padding: 8px 16px;">View Details</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
