        ...
        <div class="editorial-container" style="max-width: 1000px;">
            ...
            <c:if test="${empty bookings}">
                <div style="text-align: center; padding: 6rem 2rem; border: 1px solid var(--border);">
                    ...
                    <a href="/photographers" class="pc-btn-primary" style="padding: 1rem 2rem;">Explore Photographers</a>
                </div>
            </c:if>
                ...
                <div style="display: grid; gap: 2rem;">
                    <c:forEach var="booking" items="${bookings}">
                        <div style="border: 1px solid var(--border); padding: 2rem; display: flex; justify-content: space-between; align-items: center; border-radius: 0;">
                            <div>
                                <h3 class="editorial-heading" style="margin-bottom: 0.5rem; font-size: 1.25rem;">Session with ${booking.photographerName}</h3>
                            ...
                            <div style="text-align: right; display: flex; flex-direction: column; align-items: flex-end; gap: 1rem;">
                                ...
                                <div style="display: flex; gap: 1.5rem; align-items: center;">
                                    ...
                                    <a href="/bookings/${booking.id}" class="text-link" style="font-size: 0.95rem; padding-bottom: 2px;">View Details</a>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
