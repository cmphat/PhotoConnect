    ...
    <main style="padding: 6rem 0; min-height: 80vh;">
        <div class="editorial-container" style="max-width: 800px;">
            <div style="margin-bottom: 2rem;">
                <a href="/photographer/bookings" class="text-link" style="font-size: 0.9rem;">&larr; Back to Requests</a>
            </div>
            ...
            <div style="border: 1px solid var(--border); padding: 3rem; border-radius: 0;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 3rem; padding-bottom: 2rem; border-bottom: 1px solid var(--border-dark);">
                    <div>
                        <h2 class="editorial-heading" style="font-size: 1.5rem; margin-bottom: 0.5rem;">Request from ${booking.customerName}</h2>
                    ...
                    <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.75rem;">
                        ...
                        <a href="/bookings/${booking.id}/chat" class="pc-btn-primary" style="padding: 0.5rem 1rem; font-size: 0.85rem; display: inline-flex; align-items: center; gap: 0.5rem;">
                            💬 Open Chat
                        </a>
                    </div>
                </div>
                ...
                <c:if test="${booking.status == 'PENDING'}">
                    <div style="margin-top: 3rem; padding-top: 2rem; border-top: 1px solid var(--border-dark); display: flex; gap: 2rem; align-items: center;">
                        <form action="/photographer/bookings/${booking.id}/accept" method="post" style="margin: 0;">
                            <button type="submit" class="pc-btn-primary" style="padding: 1rem 2rem;">Accept Booking</button>
                        </form>
                        <form action="/photographer/bookings/${booking.id}/reject" method="post" onsubmit="return confirm('Are you sure you want to reject this request?');" style="margin: 0;">
                ...
                <c:if test="${booking.status == 'ACCEPTED'}">
                    <div style="margin-top: 3rem; padding-top: 2rem; border-top: 1px solid var(--border-dark);">
                        <form action="/photographer/bookings/${booking.id}/complete" method="post" onsubmit="return confirm('Mark this shoot as completed?');" style="margin: 0;">
