...
<body>
    ...
    <main style="padding: 6rem 0; min-height: 80vh;">
        <div class="editorial-container" style="max-width: 1000px;">
            <h1 class="editorial-title" style="margin-bottom: 2rem;">Booking Requests</h1>
            ...
            <c:if test="${empty bookings}">
                <div style="text-align: center; padding: 6rem 2rem; border: 1px solid var(--border);">
                    <h3 class="editorial-heading" style="font-size: 1.5rem; margin-bottom: 1rem;">No requests yet</h3>
                    <p style="color: var(--text-muted); margin-bottom: 0;">You don't have any booking requests at the moment.</p>
                </div>
            </c:if>
